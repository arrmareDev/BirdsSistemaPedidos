...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        // ── CATEGORÍAS ────────────────────────────────────
        $cats = [
            ['name' => 'Ramos',    'slug' => 'ramos',    'icon' => 'flower-2', 'sort_order' => 1, 'active' => true],
            ['name' => 'Arreglos', 'slug' => 'arreglos', 'icon' => 'flower', 'sort_order' => 2, 'active' => true],
            ['name' => 'Plantas',  'slug' => 'plantas',  'icon' => 'sprout', 'sort_order' => 3, 'active' => true],
            ['name' => 'Coronas',  'slug' => 'coronas',  'icon' => 'leaf', 'sort_order' => 4, 'active' => true],
            ['name' => 'Regalos',  'slug' => 'regalos',  'icon' => 'gift', 'sort_order' => 5, 'active' => true],
            ['name' => 'Globos',   'slug' => 'globos',   'icon' => 'party-popper', 'sort_order' => 6, 'active' => true],
        ];
        ...
        $this->command->info('OK Categorías: ' . Category::count());
        $this->command->info('OK Productos: '  . Product::count());
        $this->command->info('OK Secciones: '  . ProductCustomizationSection::count());
        $this->command->info('OK Opciones: '   . ProductCustomizationOption::count());
        $this->command->info('OK Extras: '     . ProductExtra::count());
    }
}
